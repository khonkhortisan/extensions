...
return {
	...
	parseNovel = function(url, loadChapters)
		...
		local novel = NovelInfo {
			...
			authors = mapNotNil(page:selectFirst(".woocommerce-product-attributes-item--attribute_pa_escritor"):select("a"), text),
			artists = mapNotNil(page:selectFirst(".woocommerce-product-attributes-item--attribute_pa_ilustrador"):select("a"), text),
			status = status,
