...
return {
	...
	parseNovel = function(url, loadChapters)
		...
		local novel = NovelInfo {
			...
			authors = map(page:selectFirst(".woocommerce-product-attributes-item--attribute_pa_escritor"}:select("a"), text),
			artists = map(page:selectFirst(".woocommerce-product-attributes-item--attribute_pa_ilustrador":select("a"), text),
			status = status,
