...
return {
	...
	parseNovel = function(url, loadChapters)
		...
		local novel_type = info:selectFirst(".margin-bottom-10:nth-child(1)")
		local genres_tags = info:selectFirst(".margin-bottom-10:selectFirst(.tags)")

		local s = mapNotNil(info:selectFirst(".margin-bottom-10:nth-child(2)"), function(v)
		...
		local novel = NovelInfo {
			...
			genres = map(genres_tags:select("a"), text),
			tags = map(genres_tags:select("a"), text),
